...
function CustomDrawerContent(props) {
  return (
    <DrawerContentScrollView {...props}>
      {/* Hình nền */}
      <ImageBackground
        source={require('../assets/images/anh1.png')} // Thay thế bằng đường dẫn đến hình ảnh của bạn
      ...
      >
        ...
        <View style={styles.headerContainer}>
          <Image 
            ...
            style={styles.avatar}
          />
          <Text style={styles.headerName}>Nguyễn Khoa</Text>
          <Text style={styles.headerEmail}>Khoa5108@gmail.com</Text>
        </View>
      </ImageBackground>
